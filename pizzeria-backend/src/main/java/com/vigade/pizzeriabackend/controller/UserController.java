...
import com.vigade.pizzeriabackend.application.userApplication.UserDTOInfoOutput;
...
public class UserController {
    ...
    public Mono<UserDTOInfoOutput> get(@PathVariable String id) {
        return this.userApplication.me(id);
    }
}